...
if not os.path.exists('./sessions'):
    os.mkdir('./sessions')
if not os.path.exists(f"Users/641319713/phone.csv"):
   os.mkdir('./Users')
   os.mkdir(f'./Users/641319713')
   open(f"Users/641319713/phone.csv","w")
if not os.path.exists('data.csv'):
    open("data.csv","w")
UPDATES_CHANNEL = "ProTubeSupport"
OWNER= [641319713,5612253823]
PREMIUM=[641319713,5612253823]
